...
(see [YamlTableDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/YamlTableDefLoader.html)).
...
(see [JdbcTableDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/JdbcTableDefLoader$.html)).
...
* **pk** - primary key. If not provided, might be implied (based on columns) to be `id` or `code` or a pair of refs,
  as defined in [MdConventions](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/io/MdConventions.html).fromExternalPk
...
* any other (custom) keys can be used and are sent to `extras` field of [TableDef](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/TableDef.html)
...
- father.id              person.id
```
corresponds to the following sql (as converted by [DdlGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator$.html)):
```sql
create table person(
  id bigint,
...
* additionally, any (custom) keys can be used and are sent to `extras` field of [ColumnDef](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/ColumnDef.html)
  by YamlTableDefLoader.
...
If index name is not provided [DdlGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator.html) uses
[ConstraintNamingRules](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator$$ConstraintNamingRules.html)
...
If ref name is not provided [DdlGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator.html) uses
[ConstraintNamingRules](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator$$ConstraintNamingRules.html)
...
* **_[some]_ name** - type name for specific purpose:
  * **scala name** - used by [ScalaGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/ScalaGenerator.html)
  * **xsd name** - used by [XsdGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/XsdGenerator.html)
  * any other (custom) name will also be loaded into
    `targetNames` field of [TypeDef](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/TypeDef.html)
    by [YamlTypeDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/YamlTypeDefLoader.html)
* **jdbc** - type mappings from JDBC,
  used by [JdbcTableDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/JdbcTableDefLoader$.html)
...
* **yaml** - type mappings for table and view metadata loading from mojoz yaml files,
  used by [YamlTableDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/YamlTableDefLoader.html)
  and [YamlViewDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/YamlViewDefLoader.html)
* **sql** - type info used by [DdlGenerator](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/out/DdlGenerator$.html),
  ...
  * **_[other db]_ sql** - any other keys ending with `sql` will also be loaded into
    `ddlWrite` field of [TypeDef](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/TypeDef.html)
    by [YamlTypeDefLoader](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/in/YamlTypeDefLoader.html)
...
## [API docs](https://static.javadoc.io/org.mojoz/mojoz_3/6.0.0/org/mojoz/metadata/index.html)
