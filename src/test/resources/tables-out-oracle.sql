...
create table test_table5(
  ...
  enum_for_short smallint check (enum_for_short in (-1, 0, 1)),
...
create table person(
  id numeric(18),
  full_name varchar2(128 char) not null
);
